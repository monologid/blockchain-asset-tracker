...
export async function getStaticProps() {
  return {
    props: {
      ...
      GoogleRedirectUri: process.env.GOOGLE_REDIRECT_URI || 'clientSecret',
      GoogleOauthScope: process.env.GOOGLE_OAUTH_SCOPE || 'oauthScope',

      FacebookClientId: process.env.FACEBOOK_CLIENT_ID || 'clientId',
      FacebookRedirectUri: process.env.FACEBOOK_REDIRECT_URI || 'redirectUri',
      FacebookOauthScope: process.env.FACEBOOK_OAUTH_SCOPE || 'oauthScope',
    }
  }
}
